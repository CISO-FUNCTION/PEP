...
namespace EmpPEP.Repository.EntityDataModel
{
    ...
    public partial class EmployeeKRA
    {
        ...
        public string TrainingItemId { get; set; }  // Changed to string for comma-separated IDs (NVARCHAR(500))
        public string TrainingRequirementName { get; set; }
        public string TrainingCategory { get; set; }  // New column for course categories (NVARCHAR(500))
    }
}
