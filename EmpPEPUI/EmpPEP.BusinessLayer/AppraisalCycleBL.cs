...
namespace EmpPEP.BusinessLayer
{
    public class AppraisalCycleBL
    {
        ...
        /// </summary>
        public List<AppraisalCycleEntity> GetActive()
        {
            using (var appraisalCycleRepository = new AppraisalCycleRepository())
            {
                var md_AppraisalCycle = appraisalCycleRepository.GetActive();

                if (md_AppraisalCycle != null && md_AppraisalCycle.Any())
                {
                    return Utility.ConvertToList<AppraisalCycleMaster, AppraisalCycleEntity>(md_AppraisalCycle);
                }
                return new List<AppraisalCycleEntity>();
            }
        }
        ...
        /// <summary>
        /// Stored procedure dbo.GetRatingAppraisalCycleId — used by Rating and Rating Admin.
        /// </summary>
        public int? GetRatingAppraisalCycleId(int loginEmployeeId)
        {
            using (var appraisalCycleRepository = new AppraisalCycleRepository())
            {
                return appraisalCycleRepository.GetRatingAppraisalCycleId(loginEmployeeId);
            }
        }
        ...
        public DataSet GetCyclesForTableHeaders(int currentAppraisalCycleId)
        {
            using (var appraisalCycleRepository = new AppraisalCycleRepository())
            {
                return appraisalCycleRepository.GetCyclesForTableHeaders(currentAppraisalCycleId);
            }
        }
        ...
        /// </summary>
        public List<AppraisalCycleYearbreakupDetailEntity> GetSelfAssessmentCycleDetails(int appraisalCycleId)
        {
            using (var appraisalCycleRepository = new AppraisalCycleRepository())
            {
                var cycles = appraisalCycleRepository.GetSelfAssessmentCycleDetails(appraisalCycleId);
                if (cycles != null && cycles.Count > 0)
                {
                    return Utility.ConvertToList<AppraisalCycleYearbreakupDetail, AppraisalCycleYearbreakupDetailEntity>(cycles);
                }
                return new List<AppraisalCycleYearbreakupDetailEntity>();
            }
        }
        ...
        public bool CloseSelfAssessmentCycle(int id, int closedBy)
        {
            using (var appraisalCycleRepository = new AppraisalCycleRepository())
            {
                return appraisalCycleRepository.CloseSelfAssessmentCycle(id, closedBy);
            }
        }
        ...
        public bool ReopenSelfAssessmentCycle(int id)
        {
            using (var appraisalCycleRepository = new AppraisalCycleRepository())
            {
                return appraisalCycleRepository.ReopenSelfAssessmentCycle(id);
            }
        }
